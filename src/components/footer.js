export default function Footer({ children }) {
    return (
        // <footer className="footer items-center p-4 bg-gray-400 text-neutral-content">
        <footer className="footer items-center p-4 text-neutral-content" style={{ backgroundColor: '#b23838' }}>
